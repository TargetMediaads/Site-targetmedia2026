      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <img src="https://media.base44.com/images/public/69c8f7a7f6b05b5709a82a5e/05c920c93_SymbolBlack.png" alt="Target Media Ads" className="w-9 h-9 object-contain" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            <div className="md:col-span-2">
              <Link to="/" className="flex items-center gap-2 mb-4">
                <img src="https://media.base44.com/images/public/69c8f7a7f6b05b5709a82a5e/05c920c93_SymbolBlack.png" alt="Target Media Ads" className="w-8 h-8 object-contain" />
                <div className="leading-none">
